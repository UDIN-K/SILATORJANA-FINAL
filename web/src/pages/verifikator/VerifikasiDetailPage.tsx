  ...
  return (
    <div className="space-y-6 max-w-5xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h2 className="text-2xl font-bold tracking-tight text-slate-900">Verifikasi Usulan</h2>
          <p className="text-slate-500">{data.nama_kegiatan}</p>
        </div>
      </div>
              ...
              <CardContent className="p-4 space-y-4 pt-6">
                 <div className="space-y-2">
                    ...
                    <textarea 
                      ...
                      placeholder="Masukkan catatan (opsional untuk verifikasi, wajib untuk revisi/tolak)..."
                    />
                 </div>
                 
                 <div className="flex flex-col gap-2 pt-2">
                    <Button disabled={isUpdating} onClick={() => updateStatus('verified')} className="w-full bg-emerald-600 hover:bg-emerald-700 h-10">
                       {isUpdating ? <Loader2 className="size-4 mr-2 animate-spin" /> : <Check className="size-4 mr-2" />} Verifikasi & Setujui
                    </Button>
                    ...
                    <Button disabled={isUpdating} onClick={() => updateStatus('rejected')} variant="outline" className="w-full text-red-600 border-red-200 hover:bg-red-50 hover:text-red-700 h-10">
