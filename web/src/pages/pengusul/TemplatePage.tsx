  ...
  return (
    <div className="space-y-6 max-w-4xl mx-auto">
      ...
      <div className="grid gap-4">
        {TEMPLATES.map((t, idx) => (
          <Card key={idx} className="shadow-sm border-slate-200 hover:shadow-md transition-shadow">
            <CardContent className="p-5 flex items-center gap-4">
              ...
              <div className="flex items-center gap-3 shrink-0">
                <span className="text-xs font-mono px-2 py-1 rounded bg-slate-100 text-slate-500">{t.format}</span>
                <Button variant="outline" size="sm" className="text-emerald-700 border-emerald-200 hover:bg-emerald-50" onClick={() => handleDownload(t)}>
